...
<body>
    <header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    <img src="../Images/yogurtcup.png" style="margin: 7.5%; max-width: 100%;max-height: 100%;">
                </div>
                <div class="col-md-7">
                    <h2 class="product">Blueberry Yogurt Pack</h2>
                    <table style="width:100%;">
                        <tr class="price">
                            <th><h4>$5.99</h4></th>
                            <th><h4>12x95g</h4></th>
                            <th><h4>$0.53/100g</h4></th>
                        </tr>
                    ...
                    <?php
                        print "
                            ...
                            <button type='button' onclick='change(this,true)'>+</button>
                            <input type='text' style='border:none;' name='ID2' value='1' size='1'>
                            <button type='button' onclick='change(this,false)'>-</button>
                    ...
                    <button type="button" id="addToCart"><h5>Add to Cart</h5></button>

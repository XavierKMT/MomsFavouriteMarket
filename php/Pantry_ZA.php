...
?>
    ...
    <!--The banner-->
    <br></br>
    <center> <img class="img-fluid" src="../../Images/Pantry.jpg " alt="banner for pantry"> </center>
    <br></br>
   ...
   <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
        ...
        <div class="btn-group mr-2" role="group" aria-label="Second group">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="Pantry_Relevance.php">Relevance</a>
                    <a class="dropdown-item" href="Pantry_AZ.php">Alphabetical order (A-Z)</a>
                    <a class="dropdown-item" href="Pantry_ZA.php">Alphabetical order (Z-A)</a>
                    <a class="dropdown-item" href="Pantry_PriceLH.php">Price (low to high)</a>
                    <a class="dropdown-item" href="Pantry_PriceHL.php">Price (high to low)</a>
                </div>
            </div>
        </div>
  </div>
    ...
    <div class="row">
		...
		<div class="col-sm-2 d-none d-md-block"  style = "border-right:2px solid black;">
			<table class="table">
					...
					<tbody>
					<tr>
						<td scope="row">Baking Ingredients</td>
					</tr>
					<tr>
						<td scope="row">Canned Food</td>
					</tr>
					<tr>
						<td scope="row">Soup</td>
					</tr>
					</tbody>
			</table>
		</div>
    ...
    <div class="container">
        ...
        <div class="row" >
            <?php
                ...
                echo "<div class='col-sm' id='slots'>
                <center>
                    <a href='$file[3]'><img class='img-fluid' src='../Images/$image[3]' alt='$name[3]'></img></a>
                </center>
    ...
    <div class="container">
        ...
        <div class="row" >
            ...
            <?php
                 ...
                 echo "<div class='col-sm' id='slots'>
                 <center>
                     <a href='$file[6]'><img class='img-fluid' src='../Images/$image[6]' alt='$name[6]'></img></a>
                 </center>
                 ...
                 echo "<div class='col-sm' id='slots'>
                 <center>
                     <a href='$file[5]'><img class='img-fluid' src='../Images/$image[5]' alt='$name[5]'></img></a>
                 </center>
                 ...
                 echo "<div class='col-sm' id='slots'>
                 <center>
                     <a href='$file[4]'><img class='img-fluid' src='../Images/$image[4]' alt='$name[4]'></img></a>
                 </center>
    ...
    <div class="container">
        ...
        <div class="row" >
            <?php
                ...
                echo "<div class='col-sm' id='slots'>
                <center>
                    <a href='$file[7]'><img class='img-fluid' src='../Images/$image[7]' alt='$name[7]'></img></a>
                </center>
                ...
                echo "<div class='col-sm' id='slots'>
                <center>
                    <a href='$file[9]'><img class='img-fluid' src='../Images/$image[9]' alt='$name[9]'></img></a>
                </center>
                <a href='$file[9]'> $name[9] </a>
                <br></br>";
                ...
                echo "<div class='col-sm' id='slots'>
                <center>
                    <a href='$file[8]'><img class='img-fluid' src='../Images/$image[8]' alt='$name[8]'></img></a>
                </center>

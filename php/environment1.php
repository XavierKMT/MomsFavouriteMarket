...
<body>
    ...
    <!--https://unsplash.com/photos/wHDuG1_s6NM-->
    <img alt="env" src="../Images/env.jpg" class="env" width="500px" height="400px"
        style=" display:block; margin-right: auto;margin-left: auto;   float:bellow">
    <br>
    <!--https://giphy.com/gifs/BhumiPednekar-reuse-reduce-recycle-QaN5BogCfpp6hQ4GA9-->
...
<!--talks about the approach of the market towards environment -->
    <p style=" font-size:x-large">Since 2010, our supermarkets encouraged all clients to not use plastic bags,
        ...
        carbon emissions and sustainable produce.<br><br>Our company participated in many projects since 2012, got many
        certifications<br>
        from the Government of
        Quebec for our sustainable construction methods.</p>
